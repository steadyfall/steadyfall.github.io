...
export function RecordTile({
  ...
  const DitheredOrganizationLogo = (
    <PaperTexture
      width={80}
      height={80}
      image={organizationLogo}
      colorBack={isDarkMode ? '#1a0098' : '#ff5e33'} // Dark mode: blue, Light mode: orange
      colorFront={isDarkMode ? '#1a0098' : '#ff5e33'} // Dark mode: blue, Light mode: orange
      contrast={0.3}
      roughness={0.25}
      fiber={0.4}
      fiberSize={0.01}
