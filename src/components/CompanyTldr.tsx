...
export function CompanyTldr({ arr }: CompanyTldrProps) {
  ...
  return (
    <section
      id="company-tldr"
      className="mt-[52px] border-t border-[#e9e7e1] pt-[52px] md:mt-16 md:pt-16"
      aria-label="Company Overviews"
    >
      <div className="flex flex-col gap-2.5 font-sans text-md leading-[1.6] text-[#55544f]">
